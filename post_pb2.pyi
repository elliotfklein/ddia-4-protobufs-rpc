...
class Post(_message.Message):
    __slots__ = ["author_id", "body", "id", "likes", "tags", "title"]
    ...
    title: str
    def __init__(self, id: _Optional[int] = ..., title: _Optional[str] = ..., body: _Optional[str] = ..., author_id: _Optional[str] = ..., likes: _Optional[int] = ..., tags: _Optional[_Iterable[str]] = ...) -> None: ...
